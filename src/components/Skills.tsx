...
export default function Skills({ skills }: Props) {
  ...
  return (
    ...
    >
      ...
      <h3 className="hidden md:block top-[16vh] absolute uppercase tracking-[3px] text-white text-[3vh] text-center">
        Hover over a skill for current proficiency
      </h3>
      <div className="relative max-h-[70vh] w-full flex flex-col flex-wrap place-content-center px-[10vh] gap-5 mb-[3vh] md:mb-0 pb-[8vh] md:pb-[12vh]">
        {startSkill(
          skills
