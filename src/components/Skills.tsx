...
export default function Skills({ skills }: Props) {
  ...
  return (
    ...
    >
      ...
      <h3 className="sm:hidden md:block top-[20vh] md:top-[16vh] absolute uppercase tracking-[3px] text-white text-[3vh]">
        Hover over a skill for current proficiency
      </h3>
      <div className="relative max-h-[70vh] w-full flex flex-col flex-wrap place-content-center px-[10vh] gap-5 pb-[8vh] md:pb-[12vh]">
        {startSkill(
          skills
