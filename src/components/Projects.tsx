...
export default function Projects({ projects }: Props) {
  return (
    ...
    >
      ...
      <div className="relative w-screen h-screen pt-[20vh] flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-thin scrollbar-track-teal-300/40 scrollbar-thumb-yellow-500/80">
        {projects?.map((project, i) => {
          console.log(project);
          return (
            <div
              key={project._id}
              className="w-screen px-[30vh] snap-center flex flex-col flex-shrink-0 space-y-5 items-center justify-start"
            >
              <motion.img
                ...
                alt="none available"
                className="relative w-[40vh] rounded-lg bg-red-500"
              />
              <div className="space-y-[3vh] px-[5vh]">
                ...
                <p className="text-[3vh] max-h-[20vh] overflow-y-auto scrollbar-thin scrollbar-track-teal-300/40 scrollbar-thumb-yellow-500/80 text-center">
                  {project?.summary}
                </p>
              </div>
            </div>
