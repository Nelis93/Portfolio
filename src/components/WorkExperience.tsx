...
export default function WorkExperience({ experiences }: Props) {
  return (
    ...
    >
      ...
      <div className="w-screen max-h-[80vh] px-10 md:px-0 mt-[25vh] md:mt-[20vh] flex flex-row justify-start md:justify-center space-x-5 overflow-x-scroll snap-x snap-center snap-mandatory scrollbar-thin scrollbar-track-transparent scrollbar-thumb-yellow-500/80">
